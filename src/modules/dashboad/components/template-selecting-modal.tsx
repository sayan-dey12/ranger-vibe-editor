    ...
    >
      <DialogContent className="sm:max-w-[800px] max-h-[90vh] overflow-y-auto">
        {step === "select" ? (
          <>
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-[#2563EB] flex items-center gap-2">
                  ...
                  {filteredTemplates.length > 0 ? (
                    filteredTemplates.map((template) => (
                        ...
                        className={`relative flex p-6 border rounded-lg cursor-pointer transition-all duration-300 hover:scale-[1.02]
                          ${
                            selectedTemplate === template.id
                              ? "border-[#2563EB] shadow-[0_0_0_1px_#2563EB,0_8px_20px_rgba(37,99,235,0.25)]"
                              : "hover:border-[#2563EB] shadow-[0_2px_8px_rgba(0,0,0,0.05)] hover:shadow-[0_8px_20px_rgba(37,99,235,0.15)]"
                          }`}
                      ...
                      >
                        ...
                        {selectedTemplate === template.id && (
                          <div className="absolute top-2 left-2 bg-[#2563EB] text-white rounded-full p-1">
                            <Check size={14} />
                          </div>
                        )}
                          ...
                          <div className="flex flex-col">
                            ...
                            <div className="flex flex-wrap gap-2 mt-auto">
                              {template.tags.map((tag) => (
                                <span
                                  key={tag}
                                  className="text-xs px-2 py-1 border rounded-2xl border-[#2563EB] text-[#2563EB]"
                                >
                                  {tag}
                                </span>
                              ))}
            ...
            <div className="flex justify-between gap-3 mt-4 pt-4 border-t">
              <div className="flex items-center text-sm text-muted-foreground">
                <Clock size={14} className="mr-1 text-[#2563EB]" />
                <span>
              ...
              <div className="flex gap-3">
                ...
                <Button
                  className="bg-[#2563EB] hover:bg-[#1E4ED8] text-white"
          ...
          <>
            <DialogHeader>
              <DialogTitle className="text-2xl font-bold text-[#2563EB]">
            ...
            <div className="flex flex-col gap-6 py-4">
              ...
              <div className="p-4 shadow-[0_0_0_1px_#2563EB,0_8px_20px_rgba(37,99,235,0.25)] rounded-lg border border-[#2563EB]/30">
                <h3 className="font-medium mb-2 text-[#2563EB]">
